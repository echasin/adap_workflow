...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "adap_workflow@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "adap_workflow API";

        private String description = "adap_workflow API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "adap_workflow";
